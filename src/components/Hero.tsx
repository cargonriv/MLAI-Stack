    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h1
            className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-3 sm:mb-4 leading-tight transition-all duration-1000 motion-reduce:transition-none ${
          ...
          <h2
            className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 sm:mb-6 transition-all duration-1000 delay-300 motion-reduce:transition-none ${
              isTyping ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          <p
            className={`text-base sm:text-lg md:text-xl lg:text-2xl text-foreground/80 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-500 motion-reduce:transition-none ${
              isTyping ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          <p
            className={`text-sm sm:text-base md:text-lg text-foreground/60 mb-8 sm:mb-12 max-w-2xl mx-auto transition-all duration-1000 delay-700 motion-reduce:transition-none ${
              isTyping ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            Welcome to my ML/AI Showcase: a curated collection of my most
            impactful projects.
          </p>

          {/* Social links */}
          <div
            className={`flex justify-center gap-2 sm:gap-3 md:gap-4 mb-8 sm:mb-12 transition-all duration-1000 delay-900 motion-reduce:transition-none ${
              isTyping ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            <Button
            ...
            <Button
              ...
              onClick={() =>
                window.open("https://www.github.com/cargonriv", "_blank")
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                window.open("https://www.linkedin.com/in/cargonriv", "_blank")
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                window.open("https://www.instagram.com/cargonriv", "_blank")
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                window.open("https://www.x.com/luffyswhale", "_blank")
              }
            >
          ...
          {/* CTA Button */}
          <div
            className={`transition-all duration-1000 delay-1100 motion-reduce:transition-none ${
              isTyping ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            <Button
          ...
          {/* Scroll indicator */}
          <div
            className={`mt-20 transition-all duration-1000 delay-1200 motion-reduce:transition-none ${
              isTyping ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            <div className="flex flex-col items-center space-y-1 sm:space-y-2">
              <div className="w-5 sm:w-6 h-8 sm:h-10 border-2 border-purple-400/50 rounded-full flex justify-center backdrop-blur-sm">
                <div className="w-0.5 sm:w-1 h-2 sm:h-3 bg-primary rounded-full mt-1.5 sm:mt-2 animate-bounce"></div>
              </div>
