...
import RecommendationDemo from "@/components/demos/RecommendationDemo";
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Recommendation system using matrix factorization and deep learning
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Collaborative filtering with neural networks</li>
                    <li>• Matrix factorization techniques</li>
                    <li>• User and item embeddings</li>
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• 87.5% accuracy on MovieLens 25M</li>
                    <li>• Handles sparse user-item matrices</li>
                    <li>• Personalized recommendations</li>
                    <li>• Cold start problem mitigation</li>
                  </ul>
                </div>
              </div>
            </div>
