          ...
          <div className="container mx-auto px-6">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-lg md:text-xl text-foreground/60 max-w-3xl mx-auto leading-relaxed">
                A collection of my most impactful machine learning and engineering projects, 
                showcasing innovation across healthcare, AI, and data science domains.
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project, index) => (
                  ...
                  >
                    ...
                    {/* Main card */}
                    <div className={`relative bg-gradient-to-br from-background/90 to-background/70 backdrop-blur-sm rounded-2xl border p-8 shadow-xl transition-all duration-500 ${
                      project.featured 
                      ...
                      <div className="mb-6">
                        <div className="flex items-center mb-3">
                          ...
                          <span className="text-sm font-medium text-foreground/60">Technologies</span>
                        </div>
